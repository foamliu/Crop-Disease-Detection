...
if __name__ == '__main__':
    ...
    extract('train', 'ai_challenger_pdr2018_trainingset', 'scene_train_images_20170904',
            'scene_train_annotations_20170904.json')

    extract('valid', 'ai_challenger_pdr2018_validationset', 'scene_validation_images_20170908',
            'scene_validation_annotations_20170908.json')

    extract_test('test_a', 'ai_challenger_pdr2018_testA', 'scene_test_a_images_20180103',
